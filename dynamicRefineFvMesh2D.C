...
label dynamicRefineFvMesh2D::count
(
...
void dynamicRefineFvMesh2D::calculateProtectedCells
(
...
void dynamicRefineFvMesh2D::readDict()
{
...
autoPtr<mapPolyMesh> dynamicRefineFvMesh2D::refine
(
...
// (an approximate) flux
autoPtr<mapPolyMesh> dynamicRefineFvMesh2D::unrefine
(
...
scalarField dynamicRefineFvMesh2D::maxPointField(const scalarField& pFld) const
{
...
scalarField dynamicRefineFvMesh2D::minCellField(const volScalarField& vFld) const
{
...
scalarField dynamicRefineFvMesh2D::cellToPoint(const scalarField& vFld) const
{
...
scalarField dynamicRefineFvMesh2D::error
(
...
void dynamicRefineFvMesh2D::selectRefineCandidates
(
...
labelList dynamicRefineFvMesh2D::selectRefineCells
(
...
labelList dynamicRefineFvMesh2D::selectUnrefineEdges
(
...
void dynamicRefineFvMesh2D::extendMarkedCells(PackedBoolList& markedCell) const
{
...
dynamicRefineFvMesh2D::dynamicRefineFvMesh2D(const IOobject& io)
:
    dynamicFvMesh(io),
    meshCutter_(*this),
    dumpLevel_(false),
...
dynamicRefineFvMesh2D::~dynamicRefineFvMesh2D()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool dynamicRefineFvMesh2D::update()
{
...
bool dynamicRefineFvMesh2D::writeObject
(
